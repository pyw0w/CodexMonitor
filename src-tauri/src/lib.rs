...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            codex::account_profiles_list,
            codex::account_profile_add_login,
            codex::account_profile_add_import,
            codex::account_profile_switch,
            codex::account_profile_sign_out,
            codex::account_profile_remove,
            codex::account_profile_rename,
            codex::skills_list,
            codex::apps_list,
