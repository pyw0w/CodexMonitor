...
const baseProps = {
  ...
  accountProfilesBusy: false,
  onSwitchAccountProfile: vi.fn(),
  onAddAccountProfileLogin: vi.fn(),
  onAddAccountProfileImport: vi.fn(),
  onSignOutAccountProfile: vi.fn(),
  onRenameAccountProfile: vi.fn(),
  onRemoveAccountProfile: vi.fn(),
