...
export const en: TranslationDictionary = {
  ...
  "settings.mcp.sectionSubtitle":
    "Configure MCP servers in global config.toml and inspect runtime status.",
  ...
  "settings.mcp.editorEmpty": "Select a server or add a new one.",
  ...
  "settings.mcp.actions.add": "Add server",
  ...
  "settings.mcp.enabled.subtitle": "Disable temporarily without deleting config.",
  ...
  "settings.mcp.fields.headers": "Headers",
  "settings.mcp.fields.headersPlaceholder": "Authorization=Bearer ...",
  "settings.mcp.fields.additional": "Additional TOML fields",
  ...
  "settings.mcp.runtime.noWorkspace":
    "Connect a workspace to load runtime status.",
